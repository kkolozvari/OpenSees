...
uniaxialMaterial Concrete04 4 		$fpc    $ec0  -0.05 $Ec $ft  $et ; # unconfined concrete
uniaxialMaterial Concrete04 5 		$fpcc   $ec0c -0.1  $Ec $ft  $et; # confined concrete

# uniaxialMaterial Concrete02 4 			$fpc    $ec0  	[expr 0.2*$fpc] 	-0.05 	0.3 	$ft  	100; # unconfined concrete
# uniaxialMaterial Concrete02 5 			$fpcc   $ec0c 	[expr 0.2*$fpcc] 	-0.1 	0.3 	$ft  	100; # confined concrete
...
# Element recorders
recorder Element -file $dataDir/MVLEM_Fgl.out -time -ele 1 2 3 4 5 globalForce
recorder Element -file $dataDir/MVLEM_Dsh.out -time -ele 1 2 3 4 5 ShearDef
recorder Element -file $dataDir/MVLEM_Curvature.out -time -ele 1 2 3 4 5 Curvature
...
recorder Element -file $dataDir/MVLEM_strain_stress_concrete1.out -time -ele 1 RCPanel 5 strain_stress_concrete1
recorder Element -file $dataDir/MVLEM_strain_stress_concrete2.out -time -ele 1 RCPanel 5 strain_stress_concrete2
...
#set iDmax "0.03"; #"0.001 0.0025 0.005 0.0075 0.01 0.015 0.02 0.03";
